...
import { faHome, faEnvelope, faUser, faBoxArchive, faBars, faClose } from '@fortawesome/free-solid-svg-icons'
...
const Sidebar = () => {
    ...
    return(
        <div className="nav-bar">
            ...
            <ul>
                <li>
                    <a target="_blank" rel='noreferrer' href='https://linkedin.com/in/marlinreams'>
                        <FontAwesomeIcon icon={faLinkedin} color="#4d4d4e"/>
                    </a>
                </li>
                <li>
                    <a target="_blank" rel='noreferrer' href='https://gitlab.com/marlinreams'>
